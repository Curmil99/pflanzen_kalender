...
import 'vergleichsansicht_group.dart';
import 'vergleichsansicht_shared.dart';
import 'vergleichsansicht_solo.dart';
    ...
    if (eventModus == VergleichsEventModus.solo) {
      ...
      if (_fixedIDs.isNotEmpty) {
        for (final fixedId in _fixedIDs) {
          ...
          final fixedEntryCandidates = currentEntries.where((e) => e.id == fixedId);
          final fixedEntry = fixedEntryCandidates.isNotEmpty ? fixedEntryCandidates.first : null;
          if (fixedEntry != null) {
...
void _onArrowPressed(bool forward, Vergleichseintrag eintrag) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        top: false,
        child: FutureBuilder<List<Vergleichseintrag>>(
